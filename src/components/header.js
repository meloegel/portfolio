...
const Header = () => {
    return (
        <div className="w-4/5 flex flex-col items-center justify-center text-center headerPhoto bg-center bg-no-repeat bg-cover h400px rounded-3xl text-white text-base">
            <header>
